/**
   * Made By RoyOfc
   * No Enc 100% Chat wa.me/6288980303928
*/
...
cfonts.say('Whatsapp Bot By RoyOfc',{
font: 'console',
gradient: ['red','magenta'],
align: 'center'
})
...
browser: ["YT: ROY SENPAI", "Safari", "3.0"],
auth: state
})
...
if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	...
	let butown = [{urlButton: {displayText: 'Creator 👦️',url: 'https://wa.me/6288980303928?text=Assalamualaikum'}}, {urlButton: {displayText: 'Subscribe 📱️',url: 'https://youtube.com/channel/UCm8yDv5ERW_OyiwFPni6vAg'}}, {urlButton: {displayText: 'Grup Creator 📺️',url: 'https://chat.whatsapp.com/DuwmbXQJQyw73HGAHMNEuZ'}}]
